...
namespace Pivotal.Discovery.Client
{
    ...
    public static class DiscoveryServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddDiscoveryClient(this IServiceCollection services, IConfiguration config)
        {
            ...
            AddDiscoveryServices(services, info, config);
        ...
        private static void AddDiscoveryServices(IServiceCollection services, IServiceInfo info, IConfiguration config)
        {
            ...
            if (childCount > 0 || info is EurekaServiceInfo)
            {
                ...
                {
                    EurekaConfigurer.UpdateConfiguration(config, einfo, options);
                });
