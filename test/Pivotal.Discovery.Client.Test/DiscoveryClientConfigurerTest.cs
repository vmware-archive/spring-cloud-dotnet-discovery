...
'eureka': {
    ...
    'instance': {
        ...
        [Fact]
        public void Configure_WithVCAPEnvVariables_HostName_ConfiguresEurekaDiscovery_Correctly()
        {
...
'eureka': {
    ...
    'instance': {
        ...
        [Fact]
        public void Configure_WithVCAPEnvVariables_Route_ConfiguresEurekaDiscovery_Correctly()
        {
            var vcap_application = @"
{
    'limits': {
...
'eureka': {
    ...
    'instance': {
        ...
        [Fact]
        public void Configure_WithVCAPEnvVariables_AppName_Overrides_VCAPBinding()
        {
            var vcap_application = @"
{
    'limits': {
