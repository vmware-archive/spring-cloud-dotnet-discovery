...
'eureka': {
    ...
    'instance': {
        ...
        [Fact]
        public void ConfigureDiscovery_WithVcapConfigValues_ConfiguresEurekaDiscovery_Correctly()
        {
            // Arrange
            var appsettings = @"
{
...
'eureka': {
    ...
    'instance': {
        ...
        [Fact]
        public void ConfigDiscovery_WithVCAPEnvVariables_Config_ConfiguresEurekaDiscovery_Correctly()
        {
